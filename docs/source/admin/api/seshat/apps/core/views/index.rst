...
.. autoapisummary::
   ...
   seshat.apps.core.views.last_history_year
...
.. autoapisummary::
   ...
   seshat.apps.core.views.common_map_view_content
   ...
   seshat.apps.core.views.dummy_map_view_content
...
.. py:function:: common_map_view_content(content)

   Set of functions that update content and run in each map view function.

   :param content: The content for the polity shapes.
   :type content: dict

   :returns: The updated content for the polity shapes.
   :rtype: dict
...
.. py:function:: dummy_map_view_content(content)
...
.. py:function:: get_polity_shape_content(displayed_year='all', seshat_id='all', tick_number=80, override_earliest_year=None, override_latest_year=None)
